...
export const create = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        if (args.email === identity.email) {
            throw new ConvexError("Cannot send the request to yourself");
        }
        ...
        if (
            ...
            throw new ConvexError("You are already frieds with this user");
        }
...
export const reject = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        if (!request || request.receiver !== currentUser._id) {
            throw new ConvexError("Error rejecting the request");
        }
...
export const accept = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        if (!request || request.receiver !== currentUser._id) {
            throw new ConvexError("Error accepting the request");
        }
